...
Source1002:    email-service_init_db.sh
Requires: connman
...
EMAIL_SERVICE_EXEC_SCRIPT=/etc/rc.d/init.d/email-service-serviced.sh
...
%attr(0755,root,root) /etc/rc.d/init.d/email-service-serviced.sh
