...
#include "uts-email-modify-seen-flag.h"
...
/*Testcase   : 		uts_Email_Modify_Seen_Flag_01
  TestObjective  : 	To modify mail seen flags
  APIs Tested    : 	int email_modify_seen_flag(int mail_ids[], int num, int seen_flag, int onserver)
 */

static void uts_Email_Modify_Seen_Flag_01()
{
	int err_code = EMF_ERROR_NONE;
	int mail_ids[] = {1, 2};
	int num = 0;
	int seen_flag = 1; /* Set Seen flag */
	int onserver = 0;
	int count = 0;
	emf_mailbox_t mbox;
	emf_mail_list_item_t *mail_list = NULL;

	tet_infoline("uts_Email_Modify_Seen_Flag_01 Begin\n");
	...
	err_code = email_modify_seen_flag(mail_ids, num, seen_flag, onserver);	
	if (EMF_ERROR_NONE == err_code) {
		tet_printf("Email Modify Seen Flag success\n");
		tet_result(TET_PASS);
	}
	else		{
		
		tet_printf("Email Modify Seen Flag failed : error_code[%d]\n", err_code);
		tet_result(TET_FAIL);
	}	
...
/*Testcase   : 		uts_Email_Modify_Seen_Flag_02
  TestObjective  : 	To validate parameter for modify mail seen flag
  APIs Tested    : 	int email_modify_seen_flag(int mail_ids[], int num, int seen_flag, int onserver)
 */ 
static void uts_Email_Modify_Seen_Flag_02()
{
	int err_code = EMF_ERROR_NONE;
	int *mail_ids = NULL; /* mail_ids is initialized to NULL*/
	int num = 2;
	int seen_flag = 1; /* Set Seen flag */
	int onserver = 0;


	tet_infoline("uts_Email_Modify_Seen_Flag_02 Begin\n");
...
/*Testcase   : 		uts_Email_Modify_Seen_Flag_03
  TestObjective  : 	To validate parameter for modify mail seen flag
  APIs Tested    : 	int email_modify_seen_flag(int mail_ids[], int num, int seen_flag, int onserver)
 */ 
static void uts_Email_Modify_Seen_Flag_03()
{
	int err_code = EMF_ERROR_NONE;
	int mail_ids[] = {1, 2};
	int num = 0; /* Check of boundary condition */
	int seen_flag = 1; /* Set Seen flag */
	int onserver = 0;


	tet_infoline("uts_Email_Modify_Seen_Flag_03 Begin\n");
...
/*Testcase   : 		uts_Email_Modify_Seen_Flag_04
  TestObjective  : 	To validate parameter for modify mail seen flag
  APIs Tested    : 	int email_modify_seen_flag(int mail_ids[], int num, int seen_flag, int onserver)
 */ 
static void uts_Email_Modify_Seen_Flag_04()

{
	...
	tet_infoline("uts_Email_Modify_Seen_Flag_04 Begin\n");
...
/*Testcase   : 		uts_Email_Modify_Seen_Flag_05
  TestObjective  : 	To validate parameter for modify mail seen flag
  APIs Tested    : 	int email_modify_seen_flag(int mail_ids[], int num, int seen_flag, int onserver)
 */ 
static void uts_Email_Modify_Seen_Flag_05()

{
	...
	tet_infoline("uts_Email_Modify_Seen_Flag_05 Begin\n");
